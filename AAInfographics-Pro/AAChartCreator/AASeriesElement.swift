...
public class AASeriesElement: AAObject {
    ...
    public var visible: Bool?              //Set the initial visibility of the series. Deafualt value：true
    ...
    @discardableResult
    public func visible(_ prop: Bool) -> AASeriesElement {
        visible = prop
        return self
    }
    ...
    @discardableResult
    public func keys(_ prop: [String]) -> AASeriesElement {
        keys = prop
        return self
    }
    ...
    @discardableResult
    public func baseSeries(_ prop: Any) -> AASeriesElement {
        baseSeries = prop
        return self
    }
